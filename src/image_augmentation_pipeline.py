...
def augment_image(image_path, output_folder):
    ...
    rotate_image(image, 30, output_folder, filename)
    ...
    adjust_brightness(image, 1.5, output_folder, filename)
    adjust_contrast(image, 1.5, output_folder, filename)
    shear_image(image, 0.2, output_folder, filename)
    add_gaussian_noise(image, output_folder, filename, mean=0, std=25)
...
input_folder = os.path.join(script_dir, "assets/org_oyster_images") # original images are stored here
output_folder = os.path.join(script_dir, "assets/aug_oyster_images")  # augmented images are saved here
